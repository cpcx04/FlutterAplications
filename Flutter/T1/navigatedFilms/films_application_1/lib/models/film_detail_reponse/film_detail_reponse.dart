...
class FilmDetailReponse {
  ...
  factory FilmDetailReponse.fromMap(Map<String, dynamic> data) {
    return FilmDetailReponse(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [FilmDetailReponse].
  factory FilmDetailReponse.fromJson(String data) {
    return FilmDetailReponse.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [FilmDetailReponse] to a JSON string.
